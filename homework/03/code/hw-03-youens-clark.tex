...
\begin{eqnarray*}
\begin{aligned}
\frac { \partial \log\mathcal{L}} {\partial q} &= \frac{\sum_n^N x}{q} + \frac{\sum_n^N 1 - x}{1 - q}
\\
&= q^{-1} \sum_n^N x + (1 - q)^{-1} \sum_n^N 1 - x
\\
\frac { \partial^2 \log\mathcal{L}} {\partial q} &= - q^{-2} \sum_n^N x - (1 - q)^{-2} \sum_n^N 1 - x
\\
\frac { \partial \log\mathcal{L}} {\partial q} &= \frac{x}{q} + \frac{1 - x}{1 - q} = 0
\\
&= xq^{-1} + (1-x)(1-q)^{-1}
\\
\frac { \partial^2 \log\mathcal{L}} {\partial q} 
&= -xq^{-2} - (1-x)(1-q)^{-2}
\\
\mathcal{I} &= - \frac { \partial^2 \log\mathcal{L}} {\partial q} 
\\ 
&= xq^{-2} + (1-x)(1-q)^{-2}
\end{aligned}
\end{eqnarray*}
