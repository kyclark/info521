...
# Authors: Clayton T. Morrison, 12 September 2015
#          Ken Youens-Clark, September 2018
...
def read_data(filepath, d=','):
    """
    Returns a np.array of the data.
...
def fit_mens100_data(model_order=1, scale_p=False, plot_p=False):
    ...
    Run this with model_order=6 with the scale_p=False and then again
    scale_p=True.
    ...
    read_data_fit_plot(
        data_path, model_order=model_order, scale_p=scale_p, plot_p=plot_p)
